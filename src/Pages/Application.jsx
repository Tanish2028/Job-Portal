          ...
          isEdit ? 
           <>
            <label className='flex items-center' htmlFor="resumeUpload">
              ...
              <img src={assets.profile_upload_icon} alt="" srcset="" />
            </label>
           ...
           : <div className='flex gap-2'>
            ...
            <button onClick={()=>{
              setisEdit(true)
            }} className='text-gray-500 border-gray-300 rounded-lg px-4 py-2'>Edit</button>
           </div>
        ...
        <tbody>
          {
            jobsApplied.map((job,index)=> true?(
              <tr>
                ...
                <td className='py-2 px-4 border-b'>
                  <span className={`${job.status === 'Accepted' ? 'bg-green-100' : job.status === 'Pending' ? bg-blue-100:bg-red-100} px-4 py-1.5 rounded` }>
                    {job.status}
                  </span>
