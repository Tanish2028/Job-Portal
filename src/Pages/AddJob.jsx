  ...
  return (
    <form className='container p-4 flex flex-col w-full items-start gap-3'>
        ...
        <div className='w-full'>
            ...
            <input className='w-full max-w-lg px-3 py-2 border-2 border-gray-300 rounded' type="text" value={title} placeholder='Type here' onChange={e=>setTitle(e.target.value)} required/>
