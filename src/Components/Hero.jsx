...
//Search jobs and set location section 
 
 //Some company icons on the dashboard
...
const Hero = () => {
  ...
  return (
    <div className='container 2xl:px20 mx-auto my-10'>
        <div className='bg-linear-to-r from purple-800 to to-purple-950 text-white py-16 text-center mx-2 rounded'>
            ...
            <div className='flex items-center justify-between bg-white rounded text-gray-600 max-w-xl pl4 mx-4 sm:mx-auto'>
       ...
       <div className='borrder border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex'>
